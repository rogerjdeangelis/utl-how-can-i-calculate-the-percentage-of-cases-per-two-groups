# utl-how-can-i-calculate-the-percentage-of-cases-per-two-groups
Calculate the percentage of cases per two groups
    %let pgm=utl-how-can-i-calculate-the-percentage-of-cases-per-two-groups;

    github
    https://tinyurl.com/2s3t2j75
    https://github.com/rogerjdeangelis/utl-how-can-i-calculate-the-percentage-of-cases-per-two-groups
    ...
    Calculate the percentage of cases per two groups?
    Not sure the SQL solutions are general soltions, you may have to make minor
    changes based on more realistic data.
